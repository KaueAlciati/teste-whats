window.FincontrolAPI = (() => {
  ...
  return {
    ...
    me: () => get("/auth/me"),
    requestEmailVerification: () => post("/auth/request-email-verification", {}),
    verifyEmail: (email, token) => post("/auth/verify-email", { email, token }),
    ...
    telegramStatus: () => get("/integrations/telegram/status"),
    telegramLinkCode: () => post("/integrations/telegram/code", {}),
    telegramUnlink: () => request("/integrations/telegram", { method: "DELETE" }),
  };
})();
